...
| `cdn.format.preserveTextString`    | `true`       | Keep the original spelling of double-quoted text string literals.                                                                                                                                                                                  |
| `cdn.format.preserveNumberFormat`  | `true`       | Keep the original spelling of integer and floating-point literals.                                                                                                                                                                                 |
| `cdn.format.preserveAppSequence`   | `true`       | Keep the original notation (e.g. `dt'…'` vs `DT<<…>>` vs raw tag) of extension application literals.                                                                                                                                               |
| `cdn.format.preserveBlankLines`    | `true`       | Re-emit a blank line above an array/map entry that had one in the source.                                                                                                                                                                          |
