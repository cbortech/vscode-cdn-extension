...
| `cdn.format.splitCdn`              | `false`      | Split text strings whose content parses as CDN, with structure-aware indentation.                                                                                                                                                                  |
| `cdn.format.splitNewline`          | `false`      | Split text strings at newline characters using `+` concatenation.                                                                                                                                                                                  |
